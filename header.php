<?php
	//header("Location: http://localhost/scotiabank/banca-personal/index.php");
	//die();
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<title>Scotaibank - Banca Personal</title>
	<meta name="description" content="Scotiabank El Salvador ofrece una gran variedad de soluciones de banca personal para ayudarlo a alcanzar sus objetivos.">
	<meta name="keywords" content="Banca personal, soluciones de banca personal, soluciones bancarias, banca personal de bns El Salvador">
	<meta name="author" content="Carlos López">

	<!-- Bootstrap CSS, FakeLoader CSS, App CSS-->
	...
	<link rel="shortcuticon" type="image/png" href="favicon.png">
</head>
<body>
